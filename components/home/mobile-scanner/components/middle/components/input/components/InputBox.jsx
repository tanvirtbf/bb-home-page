...
const InputBox = () => {
  return (
    <div className="flex p-2 bg-white rounded-xl">
      ...
      <input type="text" placeholder="enter your mail" className="w-full outline-none placeholder:font-normal placeholder:text-sm placeholder:text-[#222222] sm:pl-10 pl-4" />
    </div>
  );
};
